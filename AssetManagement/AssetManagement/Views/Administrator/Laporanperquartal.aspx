<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Laporanperquartal.aspx.cs" Inherits="AssetManagement.Views.Administrator.Laporanperquartal" %>
                        ...
                        <div class="col-sm-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    Laporan Monitoring | Laporan Per Quartal
                                ...
                                <div class="panel-body">
                                    <div class="form-horizontal " runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8">
                                                <select class="form-control m-b" id="txtQuartal">
                                                    <option value="">----- Pilih Quartal -----</option>
                                                    <option value="p1">Januari - April</option>
                                                    <option value="p2">Mei - Agustus</option>
                                                    <option value="p3">September - Desember</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8">
                                                ...
                                                <div class="i-checks"><label> <input type="radio" value="kmlgrafik" name="a"> <i></i> Grafik Data </label></div>
                                            </div>
                                        </div>
