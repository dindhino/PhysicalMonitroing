<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonitoringTemp.aspx.cs" Inherits="AssetManagement.Views.Administrator.MonitoringTemp" %>
...
<script runat="server">
        ...
        if (!IsPostBack)
        {
            if (Request.QueryString["actio"] != null)
            {
                ...
                else if (Request.QueryString["actio"] == "2")
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Data berhasil dihapus');window.location ='MonitoringTemp.aspx';", true);
                    //Response.Redirect("MonitoringTemp.aspx");
                }
            }
            else
            {
    ...
    protected void GetSpec(String idplant)
    {
        ...
        String strQuery1 = String.Format("SELECT * FROM [asset].[PlantSpecification] where ENDDA>GETDATE() and SPCTY='T' and PLNT1='{0}' and PLNT2={0}", idplant);
        ...
        try
        {
            ...
            if (table1.Rows.Count != 0)
            {
                ...
                txtTermometer.Text = table1.Rows[0]["SPCTY"].ToString() + "-" +
    ...
    {
        String strConnString = ConfigurationManager.ConnectionStrings["BiofarmaConnectionTest"].ConnectionString;
        String strQuery = "select * from asset.PlantSpecification where ENDDA>GETDATE() and SPCTY='T' and PLNT1=@objid and PLNT2=@objid";
        SqlConnection con = new SqlConnection(strConnString);
        SqlCommand cmd = new SqlCommand();
        cmd.Parameters.AddWithValue("@objid",
        ...
        try
        {
            ...
            {
                txtTermometer.Text = table.Rows[0]["SPCTY"].ToString() + "-" +
            ...
            {
                txtTermometer.Text = "Alat tidak ditemukan";
            }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else if (txtTermometer.Text == string.Empty)
        {
            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Informasi termometer tidak boleh kosong" + "');", true);
        }
        else if (txtTermometer.Text == "Alat tidak ditemukan")
        {
            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Informasi termometer tidak diketahui" + "');", true);
        }
            ...
            try
            {
                if (Request.QueryString["actio"] != null)
                {
                    if (Request.QueryString["actio"] == "1")
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Data berhasil disimpan');window.location ='MonitoringTemp.aspx';", true);
                    }
                }
                else
                {
                    ...
                    myCommand.Parameters.AddWithValue("@TRADT", txtTime.Text);
                    myCommand.Parameters.AddWithValue("@PLTTY", "T-" + ddlRuangan.SelectedItem.Value);
                    ...
                    myCommand.Parameters.AddWithValue("@CHUSR", (string)Session["username"]);
                    myCommand.ExecuteNonQuery();
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Data berhasil ditambahkan');window.location ='MonitoringTemp.aspx';", true);
                    //Response.Redirect("MonitoringTemp.aspx");
                }
            }
            catch (Exception ex)
    ...
    protected String GenerateData()
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["BiofarmaConnectionTest"].ConnectionString;
        String strQuery = "select * from asset.PlantMeasurement where PLTTY like 'T%' order by TRADT";
        SqlConnection con = new SqlConnection(strConnString);
        SqlCommand cmd = new SqlCommand();
        cmd.CommandType = CommandType.Text;
        cmd.CommandText = strQuery;
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Physical Monitoring | Monitoring Temperatur
                                    ...
                                    <div class="form-horizontal " runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="txtJenisMonitoring" runat="server" class="form-control m-bot15" Text="TEMPERATURE" disabled></asp:TextBox>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Termometer</label>
                                                <div class="col-lg-4 col-md-4 col-sm-4">
                                                    <asp:TextBox ID="txtTermometer" runat="server" class="form-control m-bot15" ReadOnly="true"></asp:TextBox>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4">
                                                ...
                                                <asp:LinkButton class="btn btn-round btn-danger" Visible="true" ID="btnCancel" runat="server" Text="Batal <i class='fa fa-times'></i>" href="../../Views/Administrator/MonitoringTemp.aspx" />
                                            </div>
                                        </div>
