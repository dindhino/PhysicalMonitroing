<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonitoringDiff.aspx.cs" Inherits="AssetManagement.Views.Administrator.MonitoringDiff" %>
...
<script runat="server">
        ...
        if (!IsPostBack)
        {
            if (Request.QueryString["actio"] != null)
            {
                ...
                else if (Request.QueryString["actio"] == "2")
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Data berhasil dihapus');window.location ='MonitoringDiff.aspx';", true);
                    //Response.Redirect("MonitoringDiff.aspx");
                }
            }
            else
            {
    ...
    protected void GetSpec(String idplant)
    {
        ...
        String strQuery1 = String.Format("SELECT * FROM [asset].[PlantSpecification] where ENDDA>GETDATE() and SPCTY='P' and PLNT1='{0}'", idplant);
        ...
        try
        {
            ...
            if (table1.Rows.Count != 0)
            {
                ...
                txtDPG.Text = table1.Rows[0]["SPCTY"].ToString() + "-" +
    ...
    protected void ddlRuangan_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ddlRuangan2.AppendDataBoundItems = true;
        String strConnString = ConfigurationManager.ConnectionStrings["BiofarmaConnectionTest"].ConnectionString;
        String strQuery = "select * from asset.PLANT_MASTER join asset.PLANT_RELATION on (asset.PLANT_MASTER.OBJID=asset.PLANT_RELATION.CHILD) where MAJCD='ROM' and asset.PLANT_RELATION.PARNT=@objid";
        SqlConnection con = new SqlConnection(strConnString);
        SqlCommand cmd = new SqlCommand();
    ...
    {
        String strConnString = ConfigurationManager.ConnectionStrings["BiofarmaConnectionTest"].ConnectionString;
        String strQuery = "select * from asset.PlantSpecification where ENDDA>GETDATE() and SPCTY='P' and PLNT1=@objid1 and PLNT2=@objid2";
        SqlConnection con = new SqlConnection(strConnString);
        SqlCommand cmd = new SqlCommand();
        cmd.Parameters.AddWithValue("@objid1", ddlRuangan.SelectedItem.Value);
        cmd.Parameters.AddWithValue("@objid2", ddlRuangan2.SelectedItem.Value);
        cmd.CommandType = CommandType.Text;
        cmd.CommandText = strQuery;
        cmd.Connection = con;
        try
        {
            ...
            {
                txtDPG.Text = table.Rows[0]["SPCTY"].ToString() + "-" +
            ...
            {
                txtDPG.Text = "Alat tidak ditemukan";
                txtMinal.Text = string.Empty;
                txtMaxal.Text = string.Empty;
    ...
    protected String GenerateData()
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["BiofarmaConnectionTest"].ConnectionString;
        String strQuery = "select * from asset.PlantMeasurement where PLTTY like 'P%' order by TRADT";
        SqlConnection con = new SqlConnection(strConnString);
        SqlCommand cmd = new SqlCommand();
        cmd.CommandType = CommandType.Text;
        cmd.CommandText = strQuery;
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else if (txtDPG.Text == string.Empty)
        {
            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Informasi No. DPG tidak boleh kosong" + "');", true);
        }
        else if (txtDPG.Text == "Alat tidak ditemukan")
        {
            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Informasi No. DPG tidak diketahui" + "');", true);
        }
            ...
            try
            {
                if (Request.QueryString["actio"] != null)
                {
                    if (Request.QueryString["actio"] == "1")
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Data berhasil disimpan');window.location ='MonitoringDiff.aspx';", true);
                    }
                }
                else
                {
                    ...
                    myCommand.Parameters.AddWithValue("@TRADT", txtTime.Text);
                    myCommand.Parameters.AddWithValue("@PLTTY", "P-" + ddlRuangan.SelectedItem.Value);
                    ...
                    myCommand.ExecuteNonQuery();
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Data berhasil ditambahkan');window.location ='MonitoringDiff.aspx';", true);
                    //Response.Redirect("MonitoringDiff.aspx");
                }
            }
            catch (Exception ex)
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Physical Monitoring | Monitoring Tekanan
                                    ...
                                    <div class="form-horizontal " runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="txtJenisMonitoring" runat="server" class="form-control m-bot15" Text="PRESSURE" disabled></asp:TextBox>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Ruangan 2</label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:DropDownList ID="ddlRuangan2" runat="server" class="form-control chosen-select m-bot15" AutoPostBack ="true" Enabled = "false"  OnSelectedIndexChanged="ddlRuangan2_SelectedIndexChanged">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">No. DPG</label>
                                                <div class="col-lg-4 col-md-4 col-sm-4">
                                                    <asp:TextBox ID="txtDPG" runat="server" class="form-control m-bot15" ReadOnly="true"></asp:TextBox>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4">
                                                ...
                                                <asp:LinkButton class="btn btn-round btn-danger" Visible="true" ID="btnCancel" runat="server" Text="Batal <i class='fa fa-times'></i>" href="../../Views/Administrator/MonitoringDiff.aspx" />
                                            </div>
                                        </div>
