<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetMaintenancePlan.aspx.cs" Inherits="AssetManagement.Views.Administrator.AssetMaintenancePlan" %>
...
<script runat="server">
    ...
    protected DataSet CreateDataReport(DataTable dataTable, DateTime begda, DateTime endda, string ORGNM)
    {
    ...
    protected String GenerateData(string objid)
    {
        ...
        if (Session["viewState"] != null)
        {
            ...
            DataTable _data = PreventiveMaintenance.GetAssetMaintenancePlan(objid, _initDate, _endDate);
            Session["CurrentDataSet"] = CreateDataReport(_data, _initDate, _endDate, ddlOrganization.SelectedItem.Text);
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Preventive Maintenance | Planning of Maintenance
                                ...
                                <div class="panel-body">
                                   <div class="form-horizontal " runat="server">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <p style="font-size: 15px; margin-bottom: 30px;margin-top: 30px;" align="center">
                                                <asp:Label runat="server" ID="Label1" ><strong>MAINTENANCE PLAN</strong></asp:Label></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="btn-group pull-right">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li><a href="../Reporting/AssetMaintenancePlanReporting.aspx"><i class="fa fa-print"></i> Print Document</a></li>
                                                </ul>
                                            </div>
                                        </div>
