<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Laporanpersemester.aspx.cs" Inherits="AssetManagement.Views.Administrator.Laporanpersemester" %>
                        ...
                        <div class="col-sm-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    Laporan Monitoring | Laporan Per Semester
                                ...
                                <div class="panel-body">
                                    <div class="form-horizontal " runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8">
                                                <select class="form-control m-b" id="txtSemester">
                                                    <option value="">----- Pilih Semester -----</option>
                                                    <option value="s1">Januari - Juni</option>
                                                    <option value="s2">Juli - Desember</option>
                                                </select>
                                            </div>
                                        </div>
