<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetMaintenanceUpdate.aspx.cs" Inherits="AssetManagement.Views.Administrator.AssetMaintenanceUpdate" %>
...
<script runat="server">
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            bool _isOutofDate = UpdateData();
            if (_isOutofDate) ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Silakan periksa kembali, pemeliharaan dilakukan lebih dari standard deviasi dari tanggal jatuh tempo. Jika ingin melanjutkan ubah tanggal atau berikan catatan deviasi.');", true);
            else
            {
                string _objid = Cryptography.Decrypt(Request.QueryString["objid"], true);

                UpdateDataDeviation(_objid);
    ...
    protected bool UpdateData()
    {
        ...
        return InsertAssetMaintenance(_objid.ToString());
    }

    protected void UpdateDataDeviation(string PLNID)
    {
        if (txtCatatanDeviasi.Text != string.Empty)
        {
            AssetCatalog.UpdatePlantDeviation(0, PLNID, ((int)DeviationType.PreventiveMaintenance).ToString(), DeviationType.PreventiveMaintenance.ToString(), DateTime.Now.ToString(), txtCatatanDeviasi.Text, (string)Session["username"]);
        }
    }
    ...
    protected bool InsertAssetMaintenance(string PLNID)
    {
        ...
        if (ViewState["CurrentTableMaintenance"] != null)
        {
            ...
            if (dtCurrentTable.Rows.Count > 0)
            {
                for (int rowIndex = 0; rowIndex < dtCurrentTable.Rows.Count; rowIndex++)
                {
                    ...
                    TextBox txtPlanMaintenance = (TextBox)grvMaintenance.Rows[rowIndex].Cells[4].FindControl("txtPlanMaintenance");
                    TextBox txtLastMaintenance = (TextBox)grvMaintenance.Rows[rowIndex].Cells[5].FindControl("txtLastMaintenance");

                    DateTime _plannedDate = Convert.ToDateTime(DateTimeFormat.ReverseDateVersionSQL(txtPlanMaintenance.Text));
                    DateTime _maintenedDate = Convert.ToDateTime(DateTimeFormat.ReverseDateVersionSQL(txtLastMaintenance.Text));
                    double _duration = (_maintenedDate - _plannedDate).Days;
                    int _periodeNumber = Convert.ToInt32(txtPeriode.Text.Split(' ')[0]);
                    string _periodeUnit = txtPeriode.Text.Split(' ')[1].ToLower();

                    if (_periodeUnit == "tahun")
                    {
                        if (_duration > 30)
                        {
                            _isOutofDate = true;
            ...
            if (!_isOutofDate)
            {
                if (dtCurrentTable.Rows.Count > 0)
                {
                    ...
                    for (int rowIndex = 0; rowIndex < dtCurrentTable.Rows.Count; rowIndex++)
                    {
                        ...
                        DateTime _reffDate = Convert.ToDateTime(DateTimeFormat.ReverseDateVersionSQL(dtCurrentTable.Rows[rowIndex]["ReffMaintenance"].ToString()));
                        DateTime _maintenedDate = Convert.ToDateTime(DateTimeFormat.ReverseDateVersionSQL(txtLastMaintenance.Text));

                        if (txtLastMaintenance.Text != string.Empty && (_reffDate - _maintenedDate).Days != 0)
                        {
                            ...
                            EmailNotification.SendEmailUpdatedMaintenanceNotification((string)Session["username"], (string)Session["name"], txtNumber.Text, txtAssetName.Text, ddlMaintainSubGroup.SelectedItem.Text, txtCatatanDeviasi.Text, DateTimeFormat.GetDateFormat(_maintenedDate.ToString()));
                        }
                    }
                }
            }
    ...
    protected void SetAssetMaintenanceToDataTable(string OBJID)
    {
        ...
        dt.Columns.Add(new DataColumn("PlanMaintenance", typeof(string)));
        dt.Columns.Add(new DataColumn("LastMaintenance", typeof(string)));
        dt.Columns.Add(new DataColumn("ReffMaintenance", typeof(string)));
        ...
        if (_table.Rows.Count > 0)
        {
            for (int i = 0; i < _table.Rows.Count; i++)
            {
                ...
                _row["PlanMaintenance"] = _table.Rows[i]["PLANM"].ToString() == string.Empty ? string.Empty : DateTimeFormat.ReverseDateVersionASP(_table.Rows[i]["PLANM"].ToString());
                ...
                _row["ReffMaintenance"] = _table.Rows[i]["LASTM"].ToString() == string.Empty ? string.Empty : DateTimeFormat.ReverseDateVersionASP(_table.Rows[i]["LASTM"].ToString());
    ...
    protected void SetInitialRowMaintenance()
    {
        ...
        dr["PlanMaintenance"] = string.Empty;
        dr["LastMaintenance"] = string.Empty;
        dr["ReffMaintenance"] = string.Empty;
        dt.Rows.Add(dr);
        ...
        if (ViewState["CurrentTableMaintenance"] != null)
        {
            ...
            if (dtCurrentTable.Rows.Count > 0)
            {
                for (int i = 1; i <= dtCurrentTable.Rows.Count; i++)
                {
                    ...
                    dtCurrentTable.Rows[i - 1]["PlanMaintenance"] = txtPlanMaintenance.Text;
            ...
            if (dt.Rows.Count > 0)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (i < dt.Rows.Count)
                    {
                        ...
                        txtPlanMaintenance.Text = dt.Rows[i]["PlanMaintenance"].ToString();
                                ...
                                <div class="panel-body">
                                    <div class="form-horizontal " runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <asp:GridView ID="grvMaintenance" Width="100%" BorderStyle="None" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Middle" runat="server" ShowFooter="true" class="table table-striped table-bordered table-condensed" AutoGenerateColumns="false">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Middle" FooterStyle-BorderStyle="None" ItemStyle-BorderStyle="None" HeaderStyle-BorderStyle="None" HeaderText="Group">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <%--<asp:TextBox ID="TextBox" runat="server" class="form-control form-control-inline input-medium default-date-picker" Visible="true"></asp:TextBox>--%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Middle" FooterStyle-BorderStyle="None" ItemStyle-BorderStyle="None" HeaderStyle-BorderStyle="None" HeaderText="Sub Group">
                                                            <HeaderStyle Width="21%" HorizontalAlign="Left" VerticalAlign="Middle" />
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Middle" FooterStyle-BorderStyle="None" ItemStyle-BorderStyle="None" HeaderStyle-BorderStyle="None" HeaderText="Jatuh Tempo">
                                                            <HeaderStyle Width="25%" HorizontalAlign="Left" VerticalAlign="Middle" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtPlanMaintenance" runat="server" CssClass="form-control form-control-inline input-medium update" Enabled="false" style="text-align:left;" autocomplete="off"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Middle" FooterStyle-BorderStyle="None" ItemStyle-BorderStyle="None" HeaderStyle-BorderStyle="None" HeaderText="Terakhir Pemeliharaan">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Catatan Deviasi</label>
                                            <div class="col-lg-9 col-md-9 col-sm-9">
                                                <asp:TextBox ID="txtCatatanDeviasi" runat="server" class="form-control m-bot15" TextMode="MultiLine" Rows="3" MaxLength="200"></asp:TextBox>
                                            </div>
                                        </div>
