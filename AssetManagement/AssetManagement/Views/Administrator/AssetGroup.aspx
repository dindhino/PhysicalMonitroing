<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetGroup.aspx.cs" Inherits="AssetManagement.Views.Administrator.AssetGroup" %>
...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["actio"] != null)
            {
                ...
                {
                    DelimitData(_objid);
                    Response.Redirect("AssetGroup.aspx");
                }
    ...
    {
        DataTable data = AssetCatalog.GetAssetMayorTypeByID(OBJID);

        ddlAssetType.SelectedValue = data.Rows[0]["TYPCD"].ToString();
        txtGroupCode.Text = data.Rows[0]["MAJCD"].ToString();
        txtGroupName.Text = data.Rows[0]["MAJOR"].ToString();
    }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Informasi kode grup tidak boleh kosong" + "');", true);
        }
        else if (txtGroupName.Text == string.Empty)
        {
            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Informasi nama grup tidak boleh kosong" + "');", true);
        }
        else
        {
            if (Request.QueryString["actio"] != null)
    ...
    {
        AssetCatalog.UpdateAssetMayorType(Convert.ToInt32(OBJID), txtGroupCode.Text, txtGroupName.Text, ddlAssetType.SelectedValue, ddlAssetType.SelectedItem.Text, (string)Session["username"]);
    }
    
    //Delimit
    protected void DelimitData(string OBJID)
    {
        AssetCatalog.DelimitAssetMayorType(OBJID, (string)Session["username"]);
    }
    
    //Delete
    protected void DeleteData(string OBJID)
    {
        AssetCatalog.DeleteAssetMayorType(OBJID);
    }
    ...
    protected string GetAction(string OBJID)
    {
        ...
        //Preview Detail
        element.Append("<a class='btn btn-warning popovers' style='color:white;margin-bottom:5px;' href='AssetGroup.aspx?actio=1&objid=" + Cryptography.Encrypt(OBJID, true) + "' data-content='Silakan klik untuk melakukan preview dan update data' data-placement='left' data-trigger='hover'><i class='fa fa-edit'></i></a> ");
        element.Append("<a class='btn btn-default popovers' style='color:white;margin-bottom:5px;' href='AssetGroup.aspx?actio=2&objid=" + Cryptography.Encrypt(OBJID, true) + "' data-content='Silakan klik untuk melakukan delimit data. Apakah Anda Yakin?' data-placement='left' data-trigger='hover'><i class='fa fa-recycle'></i></a> ");
        element.Append("<a class='btn btn-danger popovers' style='color:white;margin-bottom:5px;' href='AssetGroup.aspx?actio=3&objid=" + Cryptography.Encrypt(OBJID, true) + "' data-content='Silakan klik untuk menghapus data. Apakah Anda yakin?' data-placement='left' data-trigger='hover'><i class='fa fa-trash-o'></i></a> ");
    ...
    protected String GenerateData()
    {
        ...
        for (int i = 0; i < table.Rows.Count; i++)
        {
            ...
            _table.Append("<td>" + table.Rows[i]["TYPNM"].ToString() + "</td>");
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Referensi Aset | Form Group Aset
                              <span class="tools pull-right">
                                ...
                                <div class="panel-body">
                                    <div class="form-horizontal " runat="server">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Tipe Aset</label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:DropDownList ID="ddlAssetType" runat="server" class="form-control  m-bot15" onkeypress="CheckAlphabet(event);" MaxLength="100">
                                                    <asp:ListItem Value="FA" Text="FIXED ASSET"></asp:ListItem>
                                                    <asp:ListItem Value="NFA" Text="NON FIXED ASSET"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Kode Group</label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="txtGroupCode" runat="server" class="form-control  m-bot15" onkeypress="CheckAlphabet(event);" MaxLength="70">
                                                </asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <label class="col-sm-2 control-label">Nama Group</label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="txtGroupName" runat="server" class="form-control  m-bot15" MaxLength="70" ></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4">
                                                ...
                                                <asp:LinkButton class="btn btn-round btn-danger" Visible="false" ID="btnCancel" runat="server" Text="Back <i class='fa fa-times'></i>" href="../../Views/Administrator/AssetGroup.aspx" />
                                            </div>
                                        </div>
