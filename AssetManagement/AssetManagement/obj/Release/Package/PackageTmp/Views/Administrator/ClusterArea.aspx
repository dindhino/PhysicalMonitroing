<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClusterArea.aspx.cs" Inherits="AssetManagement.Views.Administrator.ClusterArea" %>
...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["actio"] != null)
            {
                ...
                {
                    DelimitData(_objid);
                    Response.Redirect("ClusterArea.aspx");
                }
    ...
    {
        DataTable data = AssetCatalog.GetClusterAreaByID(OBJID);

        txtArea.Text = data.Rows[0]["CLUST"].ToString();
        txtDeskripsi.Text = data.Rows[0]["DESCR"].ToString();
    }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Informasi lokasi area tidak boleh kosong" + "');", true);
        }
        else
        {
            if (Request.QueryString["actio"] != null)
    ...
    {
        AssetCatalog.UpdateClusterArea(Convert.ToInt32(OBJID), txtArea.Text, txtDeskripsi.Text, (string)Session["username"]);
    }
    
    //Delimit
    protected void DelimitData(string OBJID)
    {
        AssetCatalog.DelimitClusterArea(OBJID, (string)Session["username"]);
    }
    
    //Delete
    protected void DeleteData(string OBJID)
    {
        AssetCatalog.DeleteClusterArea(OBJID);
    }
    ...
    protected string GetAction(string OBJID)
    {
        ...
        //Preview Detail
        element.Append("<a class='btn btn-warning popovers' style='color:white;margin-bottom:5px;' href='ClusterArea.aspx?actio=1&objid=" + Cryptography.Encrypt(OBJID, true) + "' data-content='Silakan klik untuk melakukan preview dan update data' data-placement='left' data-trigger='hover'><i class='fa fa-edit'></i></a> ");
        element.Append("<a class='btn btn-default popovers' style='color:white;margin-bottom:5px;' href='ClusterArea.aspx?actio=2&objid=" + Cryptography.Encrypt(OBJID, true) + "' data-content='Silakan klik untuk melakukan delimit data. Apakah Anda Yakin?' data-placement='left' data-trigger='hover'><i class='fa fa-recycle'></i></a> ");
        element.Append("<a class='btn btn-danger popovers' style='color:white;margin-bottom:5px;' href='ClusterArea.aspx?actio=3&objid=" + Cryptography.Encrypt(OBJID, true) + "' data-content='Silakan klik untuk menghapus data. Apakah Anda yakin?' data-placement='left' data-trigger='hover'><i class='fa fa-trash-o'></i></a> ");
    ...
    protected String GenerateData()
    {
        ...
        DataTable table = AssetCatalog.GetClusterArea();

        for (int i = 0; i < table.Rows.Count; i++)
        {
            string _action = GetAction(table.Rows[i]["OBJID"].ToString());
            _table.Append("<tr class=''>");
            _table.Append("<td>" + table.Rows[i]["CLUST"].ToString() + "</td>");
            ...
            <section class="wrapper">
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Referensi Aset | Form Cluster Area
                                ...
                                <div class="panel-body">
                                    <div class="form-horizontal " runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="txtArea" runat="server" class="form-control  m-bot15" MaxLength="70">
                                                </asp:TextBox>
                                            </div>
                                            <label class="col-sm-1 control-label">Deskripsi</label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="txtDeskripsi" runat="server" class="form-control  m-bot15" MaxLength="200" TextMode="MultiLine" Rows="2" ></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4">
                                                ...
                                                <asp:LinkButton class="btn btn-round btn-danger" Visible="false" ID="btnCancel" runat="server" Text="Back <i class='fa fa-times'></i>" href="../../Views/Administrator/ClusterArea.aspx" />
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Referensi Aset | Cluster Area Aset
                          <span class="tools pull-right">
