<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rack.aspx.cs" Inherits="AssetManagement.Views.Administrator.Rack" %>
                                ...
                                <div class="panel-body">
                                    <div class="form-horizontal " runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-sm-1 control-label">Kode Rack</label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="txtKodeRack" runat="server" class="form-control  m-bot15" onkeypress="CheckAlphabet(event);" MaxLength="100"></asp:TextBox>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Kode Shelf</label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="txtKodeShelf" runat="server" class="form-control  m-bot15" onkeypress="CheckAlphabet(event);" MaxLength="100"></asp:TextBox>
                                            </div>
                                            <label class="col-sm-1 control-label">Kode Bin</label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="txtKodeBin" runat="server" class="form-control  m-bot15" onkeypress="CheckAlphabet(event);" MaxLength="100"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="txtMax" runat="server" class="form-control  m-bot15" TextMode="MultiLine" placeholder="Palet Maksimal"  onkeypress="CheckNumeric(event);" MaxLength="6"></asp:TextBox>
                                            </div>
                                        </div>
