<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetTransferApproval.aspx.cs" Inherits="AssetManagement.Views.Administrator.AssetTransferApproval" %>
...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                string _objid = Cryptography.Decrypt(Request.QueryString["PLNID"], true);
                string _refno = Cryptography.Decrypt(Request.QueryString["REFNO"], true);

                if (Request.QueryString["act"] == "1")
                {
                    ValidateAssetNumber(_objid, _refno);
                }
            }
        }
    }
    ...
    protected void ValidateAssetNumber(string OBJID, string REFNO)
    {
        SetDataToController(OBJID);
        SetDataTransferToController(REFNO);
        SetAssetDetailToDataTable(OBJID);
        SetImageFile(OBJID);
    }

    protected void SetDataTransferToController(string OBJID)
    {
        DataTable data = AssetCatalog.GetAssetTransferByReferenceNumber(OBJID);

        ddlNewOrganization.SelectedValue = data.Rows[0]["ORGCD"].ToString();
        ddlNewLocation.SelectedValue = data.Rows[0]["LOCID"].ToString();
        ddlNewHolder.SelectedValue = data.Rows[0]["PERNR"].ToString();
    }
    ...
    protected void SetEmployee()
    {
        ...
        ddlNewHolder.Items.Add(new ListItem("Tanpa Pemegang Aset", "0"));
        for (int i = 0; i < data.Rows.Count; i++)
        {
            ...
            ddlNewHolder.Items.Add(new ListItem(data.Rows[i]["PERNR"].ToString() + " - " + data.Rows[i]["CNAME"].ToString(), data.Rows[i]["PERNR"].ToString()));
        }
    }
    ...
    protected void SetOrganisasi()
    {
        ...
        ddlNewOrganization.Items.Clear();
        for (int i = 0; i < data.Rows.Count; i++)
        {
            ddlOrganization.Items.Add(new ListItem(data.Rows[i]["ORGNM"].ToString(), data.Rows[i]["ORGCD"].ToString()));
            ddlNewOrganization.Items.Add(new ListItem(data.Rows[i]["ORGNM"].ToString(), data.Rows[i]["ORGCD"].ToString()));
        }
    }
    ...
    protected void SetLokasi()
    {
        ...
        ddlNewLocation.Items.Clear();
        for (int i = 0; i < data.Rows.Count; i++)
        {
            ddlLocation.Items.Add(new ListItem(data.Rows[i]["CLUST"].ToString(), data.Rows[i]["OBJID"].ToString()));
            ddlNewLocation.Items.Add(new ListItem(data.Rows[i]["CLUST"].ToString(), data.Rows[i]["OBJID"].ToString()));
        }
    }
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        ...
        {
            UpdateDataApprove();
            Response.Redirect("AssetTransferApprovalList.aspx");
        }
        else
        {
    ...
    //Update set action
    protected void UpdateDataApprove()
    {
        string _plnid = Request.QueryString["PLNID"] != null ? Cryptography.Decrypt(Request.QueryString["PLNID"], true) : "0";
        string _refno = Request.QueryString["REFNO"] != null ? Cryptography.Decrypt(Request.QueryString["REFNO"], true) : "0";
        ...
        string _nilai = txtNilaiAset.Text.Split(' ')[1].Split(',')[0].Replace(".", string.Empty);

        AssetCatalog.UpdateAssetHeader(Convert.ToInt32(_plnid), _begda, _endda, txtAssetName.Text, ddlGroup.SelectedValue, ddlGroup.SelectedItem.Text, ddlSubGroup.SelectedValue, ddlSubGroup.SelectedItem.Text, txtNumber.Text, txtAssetNumber.Text, txtIdNumber.Text, ddlNewOrganization.SelectedValue, ddlNewOrganization.SelectedItem.Text, ddlNewLocation.SelectedValue, ddlNewLocation.SelectedItem.Text, ddlPerolehan.SelectedItem.Text, _tanggalPerolehan, txtPeruntukan.Text, _statusCode, _statusName, txtMTBF.Text, _nilai, txtKeterangan.Text, ddlNewHolder.SelectedValue, ddlNewHolder.SelectedItem.Text.Split('-')[ddlNewHolder.SelectedItem.Text.Split('-').Length-1], (string)Session["username"]);

        UpdateAssetTransfer(_plnid, _refno, ((int)ApprovalStatus.Approved).ToString(), ((int)WorkflowStatus.Approve).ToString());
    }

    protected void UpdateDataReject()
    {
        string _plnid = Request.QueryString["PLNID"] != null ? Cryptography.Decrypt(Request.QueryString["PLNID"], true) : "0";
        string _refno = Request.QueryString["REFNO"] != null ? Cryptography.Decrypt(Request.QueryString["REFNO"], true) : "0";
        
        UpdateAssetTransfer(_plnid, _refno, ((int)ApprovalStatus.Declined).ToString(), ((int)WorkflowStatus.Decline).ToString());
    }

    protected void UpdateAssetTransfer(string PLNID, string REFNO, string approval, string flowStatus)
    {
        AssetCatalog.UpdateAssetTransfer(PLNID, REFNO, approval, DateTime.Now.ToString(), ddlOrganization.SelectedValue, ddlOrganization.SelectedItem.Text, ddlEmployee.SelectedValue, ddlEmployee.SelectedItem.Text.Split('-')[ddlEmployee.SelectedItem.Text.Split('-').Length - 1].Trim(), ddlLocation.SelectedValue, ddlLocation.SelectedItem.Text, ddlNewOrganization.SelectedValue, ddlNewOrganization.SelectedItem.Text, ddlNewHolder.SelectedValue, ddlNewHolder.SelectedItem.Text.Split('-')[ddlNewHolder.SelectedItem.Text.Split('-').Length-1].Trim(), ddlNewLocation.SelectedValue, ddlNewLocation.SelectedItem.Text, (string)Session["username"]);
        AssetWorkflow.InsertWorkFlow(REFNO, ((int)WorkflowUser.AssetManagementApprover).ToString(), ((int)WorkflowType.Transfer).ToString(), Session["username"].ToString(), Session["poscd"].ToString(), string.Empty, flowStatus, Session["username"].ToString());
    }
                                    ...
                                    <div class="form-horizontal " runat="server">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <asp:Label runat="server" ID="Label2" ><strong>MUTASI ASET</strong></asp:Label></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12">
                                                        <asp:DropDownList ID="ddlNewOrganization" runat="server" class="chosen"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12">
                                                        <asp:DropDownList ID="ddlNewLocation" runat="server" class="chosen"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12">
                                                        <asp:DropDownList ID="ddlNewHolder" runat="server" class="chosen"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <asp:Button ID="btnDecline" runat="server" class="btn btn-red" Text="Decline" OnClick="btnDecline_Click"></asp:Button>
                                                        <asp:Button ID="btnApprove" runat="server" class="btn btn-green" Text="Approve" OnClick="btnApprove_Click"></asp:Button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
