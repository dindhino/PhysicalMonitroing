<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetCapitalization.aspx.cs" Inherits="AssetManagement.Views.Administrator.AssetCapitalization" %>
                                    ...
                                    <div class="form-horizontal " runat="server">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <asp:Label runat="server" ID="Label2" ><strong>KAPITALISASI ASET</strong></asp:Label></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-10">
                                                <div class="col-lg-3 col-md-3">
                                                    <div class="radio">
                                                        <asp:RadioButton runat="server" GroupName="NewStatus" ID="rbtNewStatusBaik" value="0" Text="Aset Baik" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-3">
                                                    <div class="radio">
                                                        <div class="form-group">
                                                            <asp:RadioButton runat="server" GroupName="NewStatus" ID="rbtNewStatusRusak" value="1" Text="Aset Rusak"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-3">
                                                    <div class="radio">
                                                        <div class="form-group">
                                                            <asp:RadioButton runat="server" GroupName="NewStatus" ID="rbtNewNonFisik" value="2" Text="Fisik Tidak Ada"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-3">
                                                    <div class="radio">
                                                        <div class="form-group">
                                                                <asp:RadioButton runat="server" GroupName="NewStatus" ID="rbtNewTidakProduktif" value="3" Text="Aset Tidak Produktif"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                        <asp:Label runat="server" ID="Label3" class="col-sm-2 control-label popovers" data-original-title='Informasi Aset' data-content='Nilai Kapitalisasi Aset. Format aset dalam satuan mata uang Rupiah (Rp). Silakan isi dengan angka desimal, contoh 1000000.00' data-placement='right' data-trigger='hover' Text="Nilai Buku"></asp:Label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="TextBox1" runat="server" class="form-control  m-bot15" Enabled="false" CssClass="form-control form-control-inline input-medium update" Text="0"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        <asp:Label runat="server" ID="Label4" class="col-sm-2 control-label popovers" data-original-title='Informasi Aset' data-content='Nomor Surat Change Control (Kapitalisasi)' data-placement='right' data-trigger='hover' Text="Nomor Surat"></asp:Label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="txtNomorSurat" runat="server" class="form-control  m-bot15" Enabled="true" CssClass="form-control form-control-inline input-medium update" Text=""></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-10">
                                                <div class="col-lg-3 col-md-3">
                                                    <div class="radio">
                                                        <asp:RadioButton runat="server" GroupName="NewStatus" ID="rbtStatusBaik" value="0" Text="Aset Baik" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-3">
                                                    <div class="radio">
                                                        <div class="form-group">
                                                            <asp:RadioButton runat="server" GroupName="NewStatus" ID="rbtStatusRusak" value="1" Text="Aset Rusak"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-3">
                                                    <div class="radio">
                                                        <div class="form-group">
                                                            <asp:RadioButton runat="server" GroupName="NewStatus" ID="rbtNonFisik" value="2" Text="Fisik Tidak Ada"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-3">
                                                    <div class="radio">
                                                        <div class="form-group">
                                                                <asp:RadioButton runat="server" GroupName="NewStatus" ID="rbtTidakProduktif" value="3" Text="Aset Tidak Produktif"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
