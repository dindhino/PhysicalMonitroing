<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Asset.aspx.cs" Inherits="AssetManagement.Views.Administrator.Asset" %>
                              ...
                              <a class="fa fa-chevron-down" href="javascript:;"></a>
                                ...
                                <div class="panel-body">
                                        <div class="adv-table">
                                                        ...
                                                        <div class="input-group pull-right">
                                                            ...
                                                            <div class="input-group-btn">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-right">
                                                                    <li>
                                                                        <asp:HyperLink runat="server" ID="HyperLink1" NavigateUrl="Asset.aspx?sync=1"><i class="fa fa-refresh fa-spin"></i> Sync ERP</asp:HyperLink></li>
                                            ...
                                            <asp:ObjectDataSource ID="ObjectDataSourceAssetFilter" runat="server" SelectMethod="GetAssetFilter" TypeName="Biofarma.AssetManagement.Business.Component.Asset">
                                                <SelectParameters>
