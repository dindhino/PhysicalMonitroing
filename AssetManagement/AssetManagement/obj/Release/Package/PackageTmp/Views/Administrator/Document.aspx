<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Document.aspx.cs" Inherits="AssetManagement.Views.Administrator.Document" %>
...
<script runat="server">
    ...
    {
        DataTable data = AssetCatalog.GetDocumentMasterByID(OBJID);

        txtDocument.Text = data.Rows[0]["DOCNM"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Informasi nama dokumen tidak boleh kosong" + "');", true);
        }
        else if (txtDescription.Text == string.Empty)
        {
            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Informasi deskripsi dokumen tidak boleh kosong" + "');", true);
        }
        else
        {
            if (Request.QueryString["actio"] != null)
    ...
    {
        AssetCatalog.UpdateDocumentMaster(Convert.ToInt32(OBJID), txtDocument.Text, txtDescription.Text, (string)Session["username"]);
    }
    
    //Delimit
    protected void DelimitData(string OBJID)
    {
        AssetCatalog.DelimitDocumentMaster(OBJID, (string)Session["username"]);
    }
    
    //Delete
    protected void DeleteData(string OBJID)
    {
        AssetCatalog.DeleteDocumentMaster(OBJID);
    }
    ...
    protected string GetAction(string OBJID)
    {
        ...
        //Preview Detail
        element.Append("<a class='btn btn-warning popovers' style='color:white;margin-bottom:5px;' href='Document.aspx?actio=1&objid=" + Cryptography.Encrypt(OBJID, true) + "' data-content='Silakan klik untuk melakukan preview dan update data' data-placement='left' data-trigger='hover'><i class='fa fa-edit'></i></a> ");
        element.Append("<a class='btn btn-default popovers' style='color:white;margin-bottom:5px;' href='Document.aspx?actio=2&objid=" + Cryptography.Encrypt(OBJID, true) + "' data-content='Silakan klik untuk melakukan delimit data. Apakah Anda Yakin?' data-placement='left' data-trigger='hover'><i class='fa fa-recycle'></i></a> ");
        element.Append("<a class='btn btn-danger popovers' style='color:white;margin-bottom:5px;' href='Document.aspx?actio=3&objid=" + Cryptography.Encrypt(OBJID, true) + "' data-content='Silakan klik untuk menghapus data. Apakah Anda yakin?' data-placement='left' data-trigger='hover'><i class='fa fa-trash-o'></i></a> ");
    ...
    protected String GenerateData()
    {
        ...
        DataTable table = AssetCatalog.GetDocumentMasters();

        for (int i = 0; i < table.Rows.Count; i++)
        {
            string _action = GetAction(table.Rows[i]["OBJID"].ToString());
            _table.Append("<tr class=''>");
            _table.Append("<td>" + table.Rows[i]["DOCNM"].ToString() + "</td>");
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Asset Document | Form Master Dokumen
                                ...
                                <div class="panel-body">
                                    <div class="form-horizontal " runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <asp:TextBox ID="txtDocument" runat="server" class="form-control  m-bot15" onkeypress="CheckAlphabet(event);" MaxLength="70">
                                                </asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4">
                                                ...
                                                <asp:LinkButton class="btn btn-round btn-danger" Visible="false" ID="btnCancel" runat="server" Text="Back <i class='fa fa-times'></i>" href="../../Views/Administrator/Document.aspx" />
                                            </div>
                                        </div>
