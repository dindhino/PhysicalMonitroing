(function() {
  ...
  Morris.Grid = (function(_super) {
    ...
    Grid.prototype.yLabelFormat = function(label) {
      if (typeof this.options.yLabelFormat === 'function') {
        ...
        return string.Empty + this.options.preUnits + (Morris.commas(label)) + this.options.postUnits;
      }
    };
  ...
  minutesSpecHelper = function(interval) {
    return {
      ...
      fmt: function(d) {
        return string.Empty + (Morris.pad2(d.getHours())) + ":" + (Morris.pad2(d.getMinutes()));
      },
      incr: function(d) {
  ...
  secondsSpecHelper = function(interval) {
    return {
      ...
      fmt: function(d) {
        return string.Empty + (Morris.pad2(d.getHours())) + ":" + (Morris.pad2(d.getMinutes())) + ":" + (Morris.pad2(d.getSeconds()));
      },
      incr: function(d) {
  ...
  Morris.LABEL_SPECS = {
    "decade": {
      ...
      fmt: function(d) {
        return string.Empty + (d.getFullYear());
      },
      incr: function(d) {
    ...
    "month": {
      ...
      fmt: function(d) {
        return string.Empty + (d.getFullYear()) + "-" + (Morris.pad2(d.getMonth() + 1));
      },
      incr: function(d) {
    ...
    "day": {
      ...
      fmt: function(d) {
        return string.Empty + (d.getFullYear()) + "-" + (Morris.pad2(d.getMonth() + 1)) + "-" + (Morris.pad2(d.getDate()));
      },
      incr: function(d) {
